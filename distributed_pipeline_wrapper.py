...
def get_process_date_list(yaml_dictionary):
    ...
    if args.experiment:
        level_0_dates = [item for item in level_0_dates if args.experiment in item else '']
        level_1_dates = [item for item in level_1_dates if args.experiment in item else '']
    else:
        print('No experiment.')
